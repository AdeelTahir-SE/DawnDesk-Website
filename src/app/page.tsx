...
function UpcomingSection({ items = upcoming }: { items?: typeof upcoming }) {
  return (
    <section className="section">
...
function UpdateTreeSection({ updates = updateTimeline }: { updates?: typeof updateTimeline }) {
  return (
    <section id="updates" className="section">
      <div className="mx-auto grid max-w-7xl gap-12 px-5 lg:grid-cols-[0.72fr_1.28fr] lg:px-8">
        ...
        <UpdateTree updates={updates} preview />
      </div>
    </section>
  );
}
    ...
    <section className="relative overflow-hidden bg-black text-white">
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-24 lg:grid-cols-[0.82fr_1.18fr] lg:px-8">
        <div className="relative z-10">
          ...
          <div className="mt-9 flex flex-wrap gap-4">
            <Link className="btn-animated rounded-md bg-[#ffc400] px-7 py-4 text-sm font-extrabold text-black" href="#download"><Download className="mr-2 inline" size={17} />Download</Link>
          </div>
        </div>
        <LaptopMockup />
      </div>
